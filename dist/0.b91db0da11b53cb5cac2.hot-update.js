...
let EventTrackingService = class EventTrackingService {
    ...
    async getAmountUserAccessWebsite() {
        ...
        const dateField = 'yourDateField';
        const countField = 'yourCountField';
        const groupByOption = 'day';
        ...
        switch (groupByOption) {
            ...
            case 'month':
                ...
                break;
            default:
                throw new Error('Invalid groupByOption. Choose "day", "week", or "month"');
        }
        const result = await this.trackingEventModel.aggregate(aggregationPipeline);
        return result;
    }
};
__decorate([
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e95aaec4dee37ec73e10")
/******/ })();
/******/ 
/******/ }
;